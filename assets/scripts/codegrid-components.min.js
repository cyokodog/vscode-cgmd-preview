...
var Et = (o, t, e) =>
  t in o
    ? wt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (o[t] = e);
...
const m = (o) => new yt(typeof o == 'string' ? o : o + '', void 0, it),
  A = (o, ...t) => {
    const e =
      o.length === 1
        ? o[0]
...
const D = window,
  rt = D.trustedTypes,
  St = rt ? rt.emptyScript : '',
  lt = D.reactiveElementPolyfillSupport,
  tt = {
    toAttribute(o, t) {
      switch (t) {
        case Boolean:
...
class w extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (r !== void 0 && this._$El !== r) {
      const n = s.getPropertyOptions(r),
        d =
          typeof n.converter == 'function'
            ...
            : tt;
      (this._$El = r),
        (this[r] = d.fromAttribute(e, n.type)),
        (this._$El = null);
    }
  }
  requestUpdate(t, e, i) {
    let s = !0;
    t !== void 0 &&
      (((i = i || this.constructor.getPropertyOptions(t)).hasChanged || mt)(
        this[t],
        e
      )
...
(w.finalized = !0),
  (w.elementProperties = /* @__PURE__ */ new Map()),
  (w.elementStyles = []),
  (w.shadowRootOptions = { mode: 'open' }),
  lt == null || lt({ ReactiveElement: w }),
  ((J = D.reactiveElementVersions) !== null && J !== void 0
    ? J
...
const V = window,
  C = V.trustedTypes,
  ct = C ? C.createPolicy('lit-html', { createHTML: (o) => o }) : void 0,
  y = `lit$${(Math.random() + '').slice(9)}$`,
  bt = '?' + y,
  Pt = `<${bt}>`,
  S = document,
  U = (o = '') => S.createComment(o),
  T = (o) => o === null || (typeof o != 'object' && typeof o != 'function'),
  At = Array.isArray,
  Ot = (o) =>
    At(o) || typeof (o == null ? void 0 : o[Symbol.iterator]) == 'function',
  N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  at = /-->/g,
  dt = />/g,
  b = RegExp(
    ...
    for (let l = 0; l < e; l++) {
        ...
        (f = n.lastIndex),
          n === N
            ? a[1] === '!--'
              ...
              ? (n = dt)
              : a[2] !== void 0
              ? (xt.test(a[2]) && (s = RegExp('</' + a[2], 'g')), (n = b))
              : a[3] !== void 0 && (n = b)
            : n === b
            ? a[0] === '>'
              ? ((n = s != null ? s : N), (h = -1))
      ...
      r +=
        n === N
          ? c + Pt
          : h >= 0
          ? (i.push(_), c.slice(0, h) + '$lit$' + c.slice(h) + y + I)
          : c + y + (h === -2 ? (i.push(void 0), l) : I);
    }
    ...
    for (; (s = E.nextNode()) !== null && l.length < d; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) {
          ...
          for (const h of s.getAttributeNames())
            if (h.endsWith('$lit$') || h.startsWith(y)) {
              ...
              if ((a.push(h), f !== void 0)) {
                const I = s.getAttribute(f.toLowerCase() + '$lit$').split(y),
                  R = /([.?@])?(.*)/.exec(f);
                l.push({
                  type: 1,
                  index: r,
          ...
          for (const h of a) s.removeAttribute(h);
        }
        ...
        if (s.data === bt) l.push({ type: 2, index: r });
        else {
          let a = -1;
  ...
  return (
    (l == null ? void 0 : l.constructor) !== c &&
      ((r = l == null ? void 0 : l._$AO) === null ||
        r === void 0 ||
        r.call(l, !1),
      c === void 0 ? (l = void 0) : ((l = new c(o)), l._$AT(o, e, i)),
      i !== void 0
        ? (((n = (d = e)._$Co) !== null && n !== void 0 ? n : (d._$Co = []))[
            i
          ] = l)
        : (e._$Cl = l)),
    l !== void 0 && (t = O(o, l._$AS(o, t.values), l, i)),
    t
  );
}
class Ut {
  ...
  v(t) {
    ...
    for (; c !== void 0; ) {
      if (d === c.index) {
        let _;
        c.type === 2
          ? (_ = new z(n, n.nextSibling, this, t))
          : c.type === 1
          ? (_ = new c.ctor(n, c.name, c.strings, this, t))
          : c.type === 6 && (_ = new zt(n, this, t)),
          this.u.push(_),
          (c = s[++l]);
      }
...
class z {
  ...
  k(t) {
    ...
    for (const r of t)
      s === e.length
        ? e.push((i = new z(this.O(U()), this.O(U()), this, this.options)))
        : (i = e[s]),
        i._$AI(r),
        s++;
  ...
  _$AI(t, e = this, i, s) {
    ...
    if (r === void 0)
      ...
      for (t = r[0], l = 0; l < r.length - 1; l++)
        (c = O(this, d[i + l], e, l)),
          c === P && (c = this._$AH[l]),
          n || (n = !T(c) || c !== this._$AH[l]),
          c === p ? (t = p) : t !== p && (t += (c != null ? c : '') + r[l + 1]),
          (this._$AH[l] = c);
    }
    n && !s && this.j(t);
  }
...
class Mt extends W {
  ...
  j(t) {
    t && t !== p
      ? this.element.setAttribute(this.name, Ht)
      : this.element.removeAttribute(this.name);
  }
}
class jt extends W {
...
vt == null || vt(H, z),
  ((G = V.litHtmlVersions) !== null && G !== void 0
    ? G
    : (V.litHtmlVersions = [])
  ).push('2.4.0');
const Bt = (o, t, e) => {
...
($.finalized = !0),
  ...
  (Q = globalThis.litElementHydrateSupport) === null ||
    Q === void 0 ||
    Q.call(globalThis, { LitElement: $ });
const gt = globalThis.litElementPolyfillSupport;
gt == null || gt({ LitElement: $ });
((X = globalThis.litElementVersions) !== null && X !== void 0
  ? X
...
const x = (o) => (t) =>
  typeof t == 'function'
    ? ((e, i) => (customElements.define(e, i), i))(o, t)
    : ((e, i) => {
...
B([g({ type: String })], L.prototype, 'src', 2);
B([g({ type: String })], L.prototype, 'file', 2);
B([g({ type: String })], L.prototype, 'title', 2);
B([g({ type: Boolean })], L.prototype, 'deferred', 2);
L = B([x('cg-livecode')], L);
...
var Wt = Object.defineProperty,
  ...
  Zt = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Kt(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
var Ft = Object.defineProperty,
  ...
  Qt = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Gt(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
var Yt = Object.defineProperty,
  ...
  ee = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? te(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
var se = Object.defineProperty,
  ...
  K = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? oe(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
let M = class extends $ {
  ...
  connectedCallback() {
    if (!this.src) throw new Error("Missing required property 'src'.");
...
K([g({ type: String })], M.prototype, 'src', 2);
K([g({ type: String })], M.prototype, 'caption', 2);
K([g({ type: String })], M.prototype, 'alt', 2);
M = K([x('cg-imgbox')], M);
...
var re = Object.defineProperty,
  ...
  Z = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? le(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
const ce = (o) =>
  o.every((t) => t.length === 2 && t.every((e) => typeof e == 'string'));
let j = class extends $ {
  constructor() {
    super(...arguments);
    u(this, 'srcset');
  ...
  connectedCallback() {
    if (!this.srcset) throw new Error("Missing required property 'srcset'.");
    if (!ce(this.srcset)) throw new Error("Invalid value of 'srcset'.");
    super.connectedCallback();
  }
  render() {
    return v`
      <figure class="cg-Video">
        ...
        <video class="cg-Video_VideoEl" controls muted>
          ${this.srcset.map(([t, e]) => v` <source src="${t}" type="${e}" /> `)}
        </video>
        <slot></slot>
      </figure>
    `;
...
Z([g({ type: Array })], j.prototype, 'srcset', 2);
Z([g({ type: String })], j.prototype, 'type', 2);
Z([g({ type: String })], j.prototype, 'caption', 2);
j = Z([x('cg-video')], j);
...
var de = Object.defineProperty,
  ...
  st = (o, t, e, i) => {
    for (
      var s = i > 1 ? void 0 : i ? he(t, e) : t, r = o.length - 1, n;
      r >= 0;
      r--
    )
      (n = o[r]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
st([g({ type: String })], q.prototype, 'src', 2);
st([g({ type: String })], q.prototype, 'caption', 2);
q = st([x('cg-audio')], q);
